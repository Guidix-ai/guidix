...
/**
 * INTERNSHIP TEMPLATE WITHOUT PHOTO - PURPLE THEME
 * Template ID: internship-template-without-photo
 * Color: Purple theme for creativity and innovation
 */
...
const InternshipTemplateWithoutPhoto = ({ resumeData, templateId, sectionOrder = ["education", "experience", "projects", "skills", "certifications", "languages"] }) => {
  const {
    personalInfo = {},
    experience = [],
    education = [],
...
export default InternshipTemplateWithoutPhoto;
