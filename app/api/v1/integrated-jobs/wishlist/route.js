...
export async function GET(request) {
  try {
    console.log('⭐ Get Wishlist Proxy - Received request');
    ...
    const backendUrl = new URL(`${API_BASE_URL}/api/v1/integrated-jobs/wishlist`);
    ...
    console.error("❌ Get wishlist proxy error:", error);
