...
```
Client-side: NEXT_PUBLIC_API_BASE_URL=http://localhost:8000 (from .env.local)
Server-side: Falls back to http://localhost:8000
```
...
- Client-side: Uses NEXT_PUBLIC_* (build-time)
